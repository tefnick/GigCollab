            ...
            <div className="bg-slate-100 dark:bg-gray-800 relative w-full z-20 top-0 start-0 border-b border-gray-300 dark:border-gray-600">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
                    ...
                    <Link href="/" className="flex items-center space-x-4 rtl:space-x-reverse">
                        <Image src={GuitarIcon} height={80} width={80} alt="guitar-icon" className="rounded-lg"/>
                    ...
                    <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        ...
                        <Link href={'/accounts/signup'}>
                            <button 
                                type="button" 
                                className="flex flex-row text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                >
                                    Sign Up
                                </button>
                        </Link>
